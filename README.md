...
**版本：`0.54.2`** · [下载 DMG](https://github.com/hxddh/Pulse/releases/tag/v0.54.2) · macOS 14+
...
（当前源码对应 [v0.54.2](https://github.com/hxddh/Pulse/releases/tag/v0.54.2)），拖进「应用程序」。
...
[`CHANGELOG.md`](CHANGELOG.md) 的 0.54.2 说明。
