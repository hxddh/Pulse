...
extension NativeActivityHarvest {
    ...
    static func applyTokenUsage(_ fact: inout Fact, _ usage: [String: Any]?) {
    ...
    static func firstValue(_ dict: [String: Any], keys: [String]) -> Any? {
    ...
    static func anyTruthy(_ dict: [String: Any], keys: [String]) -> Bool {
        let wanted = Set(keys.map(normalizedKey))
    ...
    static func isUserRecord(_ dict: [String: Any]) -> Bool {
    ...
    static func textValue(_ value: Any?, depth: Int = 0) -> String {
    ...
    static func firstNumber(_ dict: [String: Any], keys: [String]) -> Int {
    ...
    static func contextPercent(_ value: Any?) -> Int {
    ...
    static func contextLooksSession(_ context: String) -> Bool {
    ...
    static func pendingPhase(_ value: String) -> Bool {
    ...
    static func semanticPhase(_ raw: String) -> String {
    ...
    static func regexValue(_ text: String, patterns: [String]) -> String {
