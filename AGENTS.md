...
| [`docs/plan-0.58.md`](docs/plan-0.58.md) | The active plan (Fleet Continuity) |
...
0.58.0 is the current source version. Without an Apple Developer ID, GitHub
...
plan is [`docs/plan-0.58.md`](docs/plan-0.58.md) (Fleet Continuity).
