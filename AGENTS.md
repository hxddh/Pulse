...
| [`docs/plan-0.80.md`](docs/plan-0.80.md) | The active plan (Tray Legibility) |
...
0.80.0 is the current source version. Without an Apple Developer ID, GitHub
...
plan is [`docs/plan-0.80.md`](docs/plan-0.80.md) (Tray Legibility).
