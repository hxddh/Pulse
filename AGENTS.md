...
| [`docs/plan-0.93.md`](docs/plan-0.93.md) | The active plan (Look Closure) |
...
0.93.0 is the current source version. Without an Apple Developer ID, GitHub
...
plan is [`docs/plan-0.93.md`](docs/plan-0.93.md) (Look Closure).
