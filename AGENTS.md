...
| [`docs/plan-0.96.md`](docs/plan-0.96.md) | The active plan (Return Truth) |
...
0.96.0 is the current source version. Without an Apple Developer ID, GitHub
...
plan is [`docs/plan-0.96.md`](docs/plan-0.96.md) (Return Truth).
