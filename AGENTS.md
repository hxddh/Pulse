...
| [`docs/plan-0.61.md`](docs/plan-0.61.md) | The active plan (Hook Autonomy) |
...
0.61.0 is the current source version. Without an Apple Developer ID, GitHub
...
plan is [`docs/plan-0.61.md`](docs/plan-0.61.md) (Hook Autonomy).
