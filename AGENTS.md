...
| [`docs/plan-0.92.md`](docs/plan-0.92.md) | The active plan (Row Clarity) |
...
0.92.0 is the current source version. Without an Apple Developer ID, GitHub
...
plan is [`docs/plan-0.92.md`](docs/plan-0.92.md) (Row Clarity).
