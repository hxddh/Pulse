...
> **未编号。** 原为 plan-12.0；12.0 在 [`review-11.0.md`](review-11.0.md) 的评估后让给了 Kernel
> （先还结构债，再建结果契约）。本计划内容不变，仍被真机 Codex P0 证据阻塞；开工前还需要
> 一次明确的产品决定（见 review-11.0 §4.3）。文中「12.0-α/β/γ」即 Outcome-α/β/γ，
> 「12.0 这个版本号」的表述均应读作「Outcome 所取的版本号」。
